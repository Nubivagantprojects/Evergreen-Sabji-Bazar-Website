        ...
        const options = {
            ...
            handler: async function (response) {
                try {
                    ...
                    // Create user transaction document
                    const transactionId = Date.now().toString();
                    const transactionData = {
                        // balance_before: walbal,
                        // balance_after: walbal - totalAmount,
                    ...
                    await setDoc(doc(db, `userT/${formData.email}/Transactions`, transactionId), transactionData);
